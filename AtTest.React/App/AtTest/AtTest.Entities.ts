...
export module AtTestGroup {
  export const UserEntities : Basics.TypeConditionSymbol = registerSymbol("TypeCondition", "AtTestGroup.UserEntities");
  export const RoleEntities : Basics.TypeConditionSymbol = registerSymbol("TypeCondition", "AtTestGroup.RoleEntities");
  export const CurrentCustomer : Basics.TypeConditionSymbol = registerSymbol("TypeCondition", "AtTestGroup.CurrentCustomer");
}
