...
import * as AtTestClient from "./AtTest/AtTestClient"
...
Navigator.setTitleFunction(pageTitle => document.title = pageTitle ? pageTitle + " - AtTest" : "AtTest");
Navigator.setTitle();
...
Services.SessionSharing.setAppNameAndRequestSessionStorage("AtTest");
